          ...
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center">
              <div className="flex-shrink-0">
                ...
                />
                <div className="hidden h-8 px-3 bg-blue-600 text-white rounded flex items-center font-bold">
                  TestBro
                </div>
              </div>
              <span className="ml-2 text-xl font-bold text-gray-900">TestBro</span>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                ...
                <li>
                  <Link to="/legal/security" className="text-base text-gray-500 hover:text-gray-900">
                    Security
                  </Link>
                </li>
              </ul>
          ...
          <div className="mt-8 border-t border-gray-200 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-base text-gray-400">
                &copy; 2024 TestBro. All rights reserved.
              </p>
              <div className="mt-4 md:mt-0 flex space-x-6">
                <a
                  href="https://twitter.com/testbro"
                ...
                <a
                  href="https://linkedin.com/company/testbro"
                  className="text-gray-400 hover:text-gray-500"
                  target="_blank"
                  rel="noopener noreferrer"
                >
