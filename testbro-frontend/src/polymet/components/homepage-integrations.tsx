      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            TestBro.ai integrates with the tools you already use. Set up
            automated testing in your existing CI/CD pipeline and get instant
            notifications in your favorite apps.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center space-x-3 mb-6">
                  <div
                    className={`w-10 h-10 rounded-xl border-2 flex items-center justify-center ${getColorClasses(category.color)}`}
                  >
              ...
              return (
                <div key={index} className="relative">
                  <div className="bg-white rounded-xl p-6 border border-gray-200 text-center">
                    <div
                      className={`w-12 h-12 rounded-xl border-2 flex items-center justify-center mx-auto mb-4 ${getColorClasses(step.color)}`}
                    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Use our comprehensive REST API and webhooks to build custom
              integrations. Our developer-friendly documentation and SDKs make
              it easy to connect TestBro.ai with any tool in your stack.
            </p>
          ...
          <div className="bg-gray-900 rounded-2xl p-6 text-green-400 font-mono text-sm">
            ...
            <div className="space-y-2">
              ...
              <div className="ml-4">https://api.testbro.ai/v1/runs \</div>
              <div className="ml-4">
                -H{" "}
              ...
              <div className="ml-4">
                -d{" "}
                <span className="text-yellow-400">
                  '{"{"}'"target_id": "prod-app", "suite_id": "regression"{"}"}'
                </span>
              </div>
            </div>
